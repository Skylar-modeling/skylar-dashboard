  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center p-6">
      <div className="mb-12 text-center">
        <h1 className="text-4xl font-bold text-[var(--color-text-primary)] mb-2">Skylar Modeling</h1>
        <p className="text-[var(--color-text-secondary)] text-lg">Select your dashboard view</p>
      </div>
